...
This uses OpenAIEmbeddings by default; make sure OPENAI_API_KEY is set.
"""
...
from src.rag_sql.erd_generator import build_mermaid_erd
...
def build_vectorstore(
    ...
    # 4. Save FAISS index
    # -----------------------------------------------------
    # Embeddings: OpenAI (uses OPENAI_API_KEY or Azure env as configured)
